...
public class Category {
    ...
    public void open(Player player) {
        ...
        for (int i : config.getIntegerList("Menu Settings.Filler.Slots"))
            gui.setItem(i, new ItemBuilder(XMaterial.matchXMaterial(config.getString("Menu Settings.Filler.Material")).get())
                    .data(config.getInt("Menu Settings.Filler.Data")).build(), (clicker, event) -> event.setCancelled(true));
